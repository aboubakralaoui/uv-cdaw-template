...
<body id="page-top">
                    ...
                    <div id="carouselExampleIndicators2" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-item">
                            <div class="row">
                               ...
                               echo  "    <a href='descriptionFilm.html'>";
                               echo  "    <div style='border-radius: 20px;' class='card'>";
                               echo  "        <img style='height:400px;border-radius: 20px;'class='img-fluid' alt='100%x280'";
                               echo  "            src=".$films[$i]->image.">";
                               echo  "        <div class='card-body'>";
                               echo  "            <h4 class='card-title'>".$films[$i]->titre."</h4>";
                               echo  "            </div> </div></a></div>";
                            }
                                ?>
    ...
    <section id="ecrivain" style="margin-top: 100px;" class="pt-5 pb-5">
        <div class="container">
            <div class="row">
                <div class="col-6">
                    <h3 style="color: white;" class="mb-3">FILM ANIMATION </h3>
                </div>
                <div class="col-6 text-right">
                    <a class="btn btn-primary mb-3 mr-1" href="#carouselExampleIndicators2" role="button"
                        data-slide="prev">
