        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                 ...
                 <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                    ...
                    <li class="nav-item"><a class="nav-link" href="{{ url('/mangas') }}">Mangas</a></li>
                    <li class="nav-item"><a class="nav-link" href="#about"> </a></li>
                    <li class="nav-item"><a class="nav-link" href="#about"> </a></li>
                    <li class="nav-item"><a class="nav-link" href="#about"> </a></li>
                    <li class="nav-item"><a class="nav-link" href="{{ url('/user/profile') }}">Mon Profile</a></li>
                    <li class="nav-item"><a class="nav-link" href="{{ url('/mapage') }}">Mon Espace</a></li>

                    @if (Auth::user()['role'] == "administrateur")
                   <li class="nav-item"><a class="nav-link" href="{{ url('/admin') }}">Administration</a></li>           
                    @elseif  (Auth::user()['role'] == "Moderateur")
                    <li class="nav-item"><a class="nav-link" href="{{ url('/moderateur') }}">Moderation</a></li>           
